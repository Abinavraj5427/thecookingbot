...
class Attendance extends React.PureComponent {
    ...
    updateTemp(){
        // console.log("W.")
        firebase.database().ref('distance').once('value').then(
            (snapshot) => {
                ...
                this.setState({
                    ...
                    atct: this.state.atct+(temperature < 40?1:0),
                });
                this.setState({
                    percent: this.state.atct*1.0/this.state.total,
                })
            }
        )
    }
    ...
    render() {
        ...
        return (
          ...
          <Text style={styles.temperatureText}>
            Status:  {this.state.temperature < 40? "Attended": "Unattended"}
          </Text>
          <Text style={styles.temperatureText}>
            Attendance Percent:  {this.state.percent}
          </Text>
        </View>
        )
    }
